...
export const ru: LangType = {
    ...
    'page.body.landing.register.item.title': 'Your Premier Virtual Currency Exchange and Custodian Service',
    'page.body.landing.register.item.text': 'At Bohana, we pride ourselves on being the gold standard in virtual currency exchange and custodian services. Operating under 17918677, we offer a suite of meticulously crafted solutions to meet the diverse needs of our discerning clientele.',
    'page.body.landing.register.item.button': 'register',

    'page.body.landing.features.title': 'Our Authorized Activities',
    'page.body.landing.features.features.item1.title': 'Exchange Services',
    'page.body.landing.features.features.item2.title': 'Virtual Currency Pairing',
    'page.body.landing.features.features.item3.title': 'Secure Storage Solutions',
    'page.body.landing.features.features.item4.title': 'Wallet Transfers',
    'page.body.landing.features.features.item5.title': 'Fiat Currency Holding',
    'page.body.landing.features.features.item6.title': 'Crypto Wallet and Custodian Services',
    'page.body.landing.features.features.item1.text': 'Seamlessly convert virtual currency to fiat currency and vice versa with our reliable exchange platform. Our commitment to efficiency and security ensures swift and secure transactions at all times.',
    'page.body.landing.features.features.item2.text': 'Diversify your digital assets effortlessly by exchanging one virtual currency for another. Our platform facilitates seamless transactions, empowering you to optimize your portfolio with ease.',
    'page.body.landing.features.features.item3.text': 'Entrust your valuable assets to our fortified storage facilities. With stringent security protocols and advanced encryption measures, we provide unparalleled protection for your virtual currency holdings.',
    'page.body.landing.features.features.item4.text': 'Transfer your virtual currency between wallets with confidence using our intuitive transfer system. Our streamlined process prioritizes both speed and security, guaranteeing a seamless user experience.',
    'page.body.landing.features.features.item5.text': 'Safeguard your fiat currency holdings with our secure storage services. Whether for a short term or extended duration, our facilities ensure the safety of your funds as you navigate the transition into the realm of cryptocurrency.',
    'page.body.landing.features.features.item6.text': 'Benefit from our comprehensive custodian services, including the management of crypto wallets and encrypted client keys. With a meticulous attention to detail, we safeguard your assets with the utmost care and discretion.',
    ...
    'page.body.landing.footer.rights': 'Bohana © All rights reserved.',
